...
def job():
    ...
    if (len(key) == 2 and key[0] == '查'):
        ...
        if (account is not None):
            ...
            print('当前币币账户USDT: ' + spotresult['balance'])
            ...
            print('当前合约账户btc: ' + btc_amunt['equity'])
            print('当前合约账户etc: ' + etc_amunt['equity'])
            print('当前合约账户eth: ' + eth_amunt['equity'])
            print('当前合约账户eos: ' + eos_amunt['equity'])
